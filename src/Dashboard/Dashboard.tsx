...
import { BankingCard, Transaction, WeeklyActivity } from '../types';
import WeeklyActivitBarChart from '../components/WeeklyActivityBarChart';
    ...
    <div className="h-full flex flex-col gap-4">
      ...
      <div className='flex flex-col gap-4 sm:flex-row justify-between'>
        ...
        <section className='flex-grow'>
          ...
          <div className="mt-4 bg-white rounded-lg p-4 border-box h-[17.8125rem] sm:h-[20.125rem] sm:max-h-[20.125rem]">
